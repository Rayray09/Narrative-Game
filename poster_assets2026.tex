...
%% Based on the official ACM Master Article Template (acmart, sigconf).
%% Compile: pdflatex -> bibtex -> pdflatex -> pdflatex
\documentclass[sigconf]{acmart}

%% --- Rights / conference metadata (placeholder values; update for
%%     the ASSETS '26 camera-ready, or replace with the values the CfP
%%     gives you). These are required by the official ACM template. ---
